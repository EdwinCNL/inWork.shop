...
<div class="row m-4">
    <div class="col-xl-12 col-md-12 col-lg-12 pr-md-1">
        <ul class="nav nav-tabs nav-light">
            ...
            <li class="nav-item"><a class="nav-link <?php if ($parameters['tab_id'] == '0' or $parameters['tab_id'] == '') print 'active'?>"  href="?page=booknetic&module=whatsappnotifications"><?php print bkntc__('DEFAULT')?></a></li>
            <?php
            ...
            foreach ($parameters['tabs'] as $tab)
            {
                ...
                print '<li class="nav-item">
                            <a class="nav-link '.$active.'" href="?page=booknetic&module=whatsappnotifications&tab_id='.(int) $tab['id'].'">'.esc_html($tab['name']).'</a>
