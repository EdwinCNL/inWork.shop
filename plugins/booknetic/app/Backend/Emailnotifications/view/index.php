...
<?php if( Helper::isSaaSVersion() ):?>
	...
	<div class="m_header_alert">
		<div class="alert alert-<?php print ( $allowedLimit[0] ? 'success' : 'danger' )?>">
			...
			<div>
				<a href="?page=booknetic&module=billing&upgrade=1" class="btn btn-secondary"><?php print bkntc__('UPGRADE PLAN')?></a>
			</div>
		</div>
	</div>
<?php endif;?>
...
<div class="row m-4">
    ...
    <div class="col-xl-12 col-md-12 col-lg-12 pr-md-1">
        <ul class="nav nav-tabs nav-light">
            ...
            <li class="nav-item"><a class="nav-link <?php if ($parameters['tab_id'] == '0' or $parameters['tab_id'] == '') print 'active'?>"  href="?page=booknetic&module=emailnotifications"><?php print bkntc__('DEFAULT')?></a></li>
            <?php
            ...
            foreach ($parameters['tabs'] as $tab)
            {
                ...
                print '<li class="nav-item">
                            <a class="nav-link '.$active.'" href="?page=booknetic&module=emailnotifications&tab_id='.(int) $tab['id'].'">'.esc_html($tab['name']).'</a>
